    ...
    <div className="flex flex-col pb-4">
      ...
      <div className="relative -mx-4 -mt-4 mb-6">
        <div
          ...
          style={{
            background: 'linear-gradient(135deg, rgba(234,179,8,0.18) 0%, rgba(15,23,42,0) 60%)',
          }}
        >
          {/* Fondo decorativo */}
          ...
          >
            ...
            {!isLocked && (
              <button
                ...
                className="text-xs text-muted border border-border rounded-lg px-3 py-2 hover:border-gold/60 hover:text-white transition-colors shrink-0"
              >
                Cambiar
              </button>
            )}
      ...
      {picks.length === 0 && !isLocked && (
        <p className="text-center text-muted text-xs mt-2">Sé el primero en predecir al campeón</p>
      )}
